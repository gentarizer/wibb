...
cl = WIB.LINE()
cl.login(token="Epf1mXKX3v1prlUc67jc.bXcKkNxGPhATAhy524WgNa.P1u4zHqx1cLLRk6V5VrV16cYlHfYUKlSpLwG+sXYBq8=")
cl.loginResult()
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Ngapain ngeadd?",
    'sticker':False,
    "lang":"JP",
    "comment":"Aᴜᴛᴏ Lɪᴋᴇ ʙʏ 404\n\nline://ti/p/~nesawiraguna",
    "commentOn":True,
    "autoLike":True,
    "commentBlack":{},
    "wblack":False,
    ...
    "settings":"dset",
    "gift":"Gift",
    "tagtext":"Apasih lu ngetag ngetag \n Sok akrab lu bajingan",
    "spamgrup":"TERCYDUCK",
    "detectAll":False, 
    "cName":"",
    "alwaysRead":False,
...
#                 cl.sendImageWithURL(msg.to,xxx)
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u0710a42a75e0a476ad687639db8c069c":
                    if "join:" in msg.text:
